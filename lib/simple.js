...
const { proto, downloadContentFromMessage, jidDecode, areJidsSameUser, generateForwardMessageContent, generateWAMessageFromContent,extractMessageContent, getContentType } = (await import('@adiwajshing/baileys')).default

/**@param {import('./connection').Socket} conn*/
export function HelperConnection(conn, options = {}) { const botUser = conn.user || {}
    /**@type {import('@adiwajshing/baileys').WASocket | import('@adiwajshing/baileys').WALegacySocket} */
    let sock = Object.defineProperties(conn, {
        decodeJid: { value(jid) { if (!jid || typeof jid !== 'string') return (!nullish(jid) && jid) || null
         return jid?.decodeJid?.() }, configurable: true},
        logger: { value: { info(...args) { console.log(chalk.bold.bgRgb(51, 204, 51)('INFO '+Intl.DateTimeFormat().resolvedOptions().timeZone), `[${chalk.rgb(255, 255, 255)(moment().tz(Intl.DateTimeFormat().resolvedOptions().timeZone).format('DD/MM/YY HH:mm:ss'))}]:`, chalk.cyan(format(...args)))}, error(...args) { console.log( chalk.bold.bgRgb(247, 38, 33)('ERROR '), `[${chalk.rgb(255, 255, 255)(moment().tz(Intl.DateTimeFormat().resolvedOptions().timeZone).format('DD/MM/YY HH:mm:ss'))}]:`, chalk.rgb(255, 38, 0)(format(...args)))}, warn(...args) { console.log( chalk.bold.bgRgb(255, 153, 0)('AVISO '), `[${chalk.rgb(255, 255, 255)(moment().tz(Intl.DateTimeFormat().resolvedOptions().timeZone).format('DD/MM/YY HH:mm:ss'))}]:`, chalk.redBright(format(...args)))}, trace(...args) { console.log(chalk.grey('RASTRO '), `[${chalk.rgb(255, 255, 255)(moment().tz(Intl.DateTimeFormat().resolvedOptions().timeZone).format('DD/MM/YY HH:mm:ss'))}]:`, chalk.white(format(...args)) )}, debug(...args) { console.log( chalk.bold.bgRgb(66, 167, 245)('DEPURAR '), `[${chalk.rgb(255, 255, 255)(moment().tz(Intl.DateTimeFormat().resolvedOptions().timeZone).format('DD/MM/YY HH:mm:ss'))}]:`, chalk.white(format(...args)))}}, enumerable: true, writable: true },
